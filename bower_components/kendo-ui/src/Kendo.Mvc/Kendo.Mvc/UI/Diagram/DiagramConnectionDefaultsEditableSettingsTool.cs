namespace Kendo.Mvc.UI
{
    ...
    public class DiagramConnectionDefaultsEditableSettingsTool : JsonObject
    {
        public DiagramConnectionDefaultsEditableSettingsTool()
        {
            ...
            Buttons = new List<DiagramConnectionDefaultsEditableSettingsToolButton>();
                
            MenuButtons = new List<DiagramConnectionDefaultsEditableSettingsToolMenuButton>();
        ...
        public List<DiagramConnectionDefaultsEditableSettingsToolButton> Buttons
        {
            get;
            set;
        }
        ...
        public List<DiagramConnectionDefaultsEditableSettingsToolMenuButton> MenuButtons
        {
            get;
            set;
        }
