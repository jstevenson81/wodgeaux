namespace Kendo.Mvc.UI.Fluent
{
        ...
        where TConnectionModel : class
    {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> HtmlAttributes(object value)
        {
        ...
        /// </summary>
        /// <param name="value">The value that configures the htmlattributes.</param>
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> HtmlAttributes(IDictionary<string,object> value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Buttons(Action<DiagramConnectionEditableSettingsToolButtonFactory<TShapeModel,TConnectionModel>> configurator)
        {
            configurator(new DiagramConnectionEditableSettingsToolButtonFactory<TShapeModel,TConnectionModel>(container.Buttons));
            return this;
        }
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Click(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Enable(bool value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Group(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Icon(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Id(string value)
        {
            container.Id = value;
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> ImageUrl(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> MenuButtons(Action<DiagramConnectionEditableSettingsToolMenuButtonFactory<TShapeModel,TConnectionModel>> configurator)
        {
            configurator(new DiagramConnectionEditableSettingsToolMenuButtonFactory<TShapeModel,TConnectionModel>(container.MenuButtons));
            return this;
        }
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Overflow(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> OverflowTemplate(string value)
        {
        ...
        /// </summary>
        /// <param name="value">The value that configures the overflowtemplate.</param>
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> OverflowTemplateId(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Primary(bool value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Selected(bool value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> ShowIcon(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> ShowText(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> SpriteCssClass(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Template(string value)
        {
        ...
        /// </summary>
        /// <param name="value">The value that configures the template.</param>
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> TemplateId(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Text(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Togglable(bool value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Toggle(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Type(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Url(string value)
        {
            container.Url = value;
