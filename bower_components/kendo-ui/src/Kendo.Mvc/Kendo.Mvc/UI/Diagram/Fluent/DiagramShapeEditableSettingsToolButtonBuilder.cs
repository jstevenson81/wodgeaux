namespace Kendo.Mvc.UI.Fluent
{
    ...
    /// </summary>
    public class DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel>: IHideObjectMembers where TShapeModel : class  where TConnectionModel : class
    {
        private readonly DiagramShapeEditableSettingsToolButton container;

        public DiagramShapeEditableSettingsToolButtonBuilder(DiagramShapeEditableSettingsToolButton settings)
        {
            container = settings;
        }
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> HtmlAttributes(object value)
        {
        ...
        /// </summary>
        /// <param name="value">The value that configures the htmlattributes.</param>
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> HtmlAttributes(IDictionary<string,object> value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Click(string value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Enable(bool value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Group(string value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Icon(string value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Id(string value)
        {
            container.Id = value;
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> ImageUrl(string value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Selected(bool value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> ShowIcon(string value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> ShowText(string value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> SpriteCssClass(string value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Toggle(string value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Togglable(bool value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Text(string value)
        {
        ...
        public DiagramShapeEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Url(string value)
        {
            container.Url = value;
