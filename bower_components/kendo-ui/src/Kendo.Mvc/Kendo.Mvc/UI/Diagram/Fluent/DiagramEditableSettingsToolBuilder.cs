namespace Kendo.Mvc.UI.Fluent
{
        ...
        where TConnectionModel : class
    {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> HtmlAttributes(object value)
        {
        ...
        /// </summary>
        /// <param name="value">The value that configures the htmlattributes.</param>
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> HtmlAttributes(IDictionary<string,object> value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Buttons(Action<DiagramEditableSettingsToolButtonFactory<TShapeModel,TConnectionModel>> configurator)
        {
            configurator(new DiagramEditableSettingsToolButtonFactory<TShapeModel,TConnectionModel>(container.Buttons));
            return this;
        }
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Click(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Enable(bool value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Group(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Icon(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Id(string value)
        {
            container.Id = value;
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> ImageUrl(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> MenuButtons(Action<DiagramEditableSettingsToolMenuButtonFactory<TShapeModel,TConnectionModel>> configurator)
        {
            configurator(new DiagramEditableSettingsToolMenuButtonFactory<TShapeModel,TConnectionModel>(container.MenuButtons));
            return this;
        }
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Overflow(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> OverflowTemplate(string value)
        {
        ...
        /// </summary>
        /// <param name="value">The value that configures the overflowtemplate.</param>
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> OverflowTemplateId(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Primary(bool value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Selected(bool value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> ShowIcon(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> ShowText(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> SpriteCssClass(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Template(string value)
        {
        ...
        /// </summary>
        /// <param name="value">The value that configures the template.</param>
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> TemplateId(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Text(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Togglable(bool value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Toggle(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Type(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Url(string value)
        {
            container.Url = value;
