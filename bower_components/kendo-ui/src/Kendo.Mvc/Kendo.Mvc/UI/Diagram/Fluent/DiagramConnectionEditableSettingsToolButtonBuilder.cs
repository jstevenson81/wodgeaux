namespace Kendo.Mvc.UI.Fluent
{
    ...
    /// </summary>
    public class DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel>: IHideObjectMembers where TShapeModel : class  where TConnectionModel : class
    {
        private readonly DiagramConnectionEditableSettingsToolButton container;

        public DiagramConnectionEditableSettingsToolButtonBuilder(DiagramConnectionEditableSettingsToolButton settings)
        {
            container = settings;
        }
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> HtmlAttributes(object value)
        {
        ...
        /// </summary>
        /// <param name="value">The value that configures the htmlattributes.</param>
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> HtmlAttributes(IDictionary<string,object> value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Click(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Enable(bool value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Group(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Icon(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Id(string value)
        {
            container.Id = value;
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> ImageUrl(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Selected(bool value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> ShowIcon(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> ShowText(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> SpriteCssClass(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Toggle(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Togglable(bool value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Text(string value)
        {
        ...
        public DiagramConnectionEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Url(string value)
        {
            container.Url = value;
