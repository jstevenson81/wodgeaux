namespace Kendo.Mvc.UI.Fluent
{
    ...
    /// </summary>
    public class DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel>: IHideObjectMembers where TShapeModel : class  where TConnectionModel : class
    {
        private readonly DiagramShapeDefaultsEditableSettingsToolButton container;

        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder(DiagramShapeDefaultsEditableSettingsToolButton settings)
        {
            container = settings;
        }
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> HtmlAttributes(object value)
        {
        ...
        /// </summary>
        /// <param name="value">The value that configures the htmlattributes.</param>
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> HtmlAttributes(IDictionary<string,object> value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Click(string value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Enable(bool value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Group(string value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Icon(string value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Id(string value)
        {
            container.Id = value;
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> ImageUrl(string value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Selected(bool value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> ShowIcon(string value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> ShowText(string value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> SpriteCssClass(string value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Toggle(string value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Togglable(bool value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Text(string value)
        {
        ...
        public DiagramShapeDefaultsEditableSettingsToolButtonBuilder<TShapeModel,TConnectionModel> Url(string value)
        {
            container.Url = value;
