namespace Kendo.Mvc.UI
{
    ...
    public class DiagramConnectionEditableSettingsTool : JsonObject
    {
        public DiagramConnectionEditableSettingsTool()
        {
            ...
            Buttons = new List<DiagramConnectionEditableSettingsToolButton>();
                
            MenuButtons = new List<DiagramConnectionEditableSettingsToolMenuButton>();
        ...
        public List<DiagramConnectionEditableSettingsToolButton> Buttons
        {
            get;
            set;
        }
        ...
        public List<DiagramConnectionEditableSettingsToolMenuButton> MenuButtons
        {
            get;
            set;
        }
