namespace Kendo.Mvc.UI
{
    ...
    public class DiagramEditableSettingsTool : JsonObject
    {
        public DiagramEditableSettingsTool()
        {
            ...
            Buttons = new List<DiagramEditableSettingsToolButton>();
                
            MenuButtons = new List<DiagramEditableSettingsToolMenuButton>();
        ...
        public List<DiagramEditableSettingsToolButton> Buttons
        {
            get;
            set;
        }
        ...
        public List<DiagramEditableSettingsToolMenuButton> MenuButtons
        {
            get;
            set;
        }
